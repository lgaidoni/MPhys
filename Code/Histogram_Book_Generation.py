...
def AnalysisAutoGen_TLorentz(InputTLorentzName, DesiredTLorentzName, Units):
	if InputTLorentzName == DesiredTLorentzName:
		...
		#To fill the HIGH_E Section inside SOMETHING_Analysis.h
		...
		if (line.find("matched") != -1 and line.find("matched_p4") == -1) or (line.find("truth") != -1 and line.find("truth_p4") != -1):
			...
			if line[3:17] == "TLorentzVector":
				...
				for lorentzline in TLorentzVector_Leaves:
					...
					Histo_Definitions.write("\t\tTH1F\t*h_" + leafName + "_" + TLorentzName + "_EXCEPT_FINE;\n")
					...
					Histo_Book_Functions_AutoGen.write("\t\th_" + leafName + "_" + TLorentzName + "_EXCEPT_FINE = new TH1F(\"h_" + leafName + "_" + TLorentzName + "_EXCEPT_FINE\",\"\", 10000, min, max);\n")
					...
					Histo_Book_Functions_AutoGen.write("\t\thv_" + leafName + "_" + TLorentzName + ".push_back(h_" + leafName + "_" + TLorentzName + "_EXCEPT_FINE);\n")	
					...
					Histo_Book_Functions_AutoGen.write("\t\thv_" + leafName + "_" + TLorentzName + "_names.push_back(\"h_" + leafName + "_" + TLorentzName + "_EXCEPT_FINE\");\n")
			...
			#If the leaf is anything else
				...
				Histo_Definitions.write("\tTH1F\t*h_" + leafName + "_EXCEPT_FINE;\n")
				...
				Histo_Book_Functions_AutoGen.write("\th_" + leafName + "_EXCEPT_FINE = new TH1F(\"h_" + leafName + "_EXCEPT_FINE\", \"\", bins, min, max);\n")
				...
				Histo_Book_Functions_AutoGen.write("\thv_" + leafName + ".push_back(h_" + leafName + "_EXCEPT_FINE);\n")	
				...
				Histo_Book_Functions_AutoGen.write("\thv_" + leafName + "_names.push_back(\"h_" + leafName + "_EXCEPT_FINE\");\n")
...
for line in Custom_Histos:
	...
	if line[0:2] == "##": # If the line is a comment for separating things out
		...
		Histo_Custom_Book_Definitions.write("TH1F\t*h_" + line[0:colonPos] + "_EXCEPT_FINE; // EXCEPT_FINE VERSION\n")
		...
		Histo_Custom_Book_Functions.write("\th_" + line[0:colonPos] + "_EXCEPT_FINE = new TH1F(\"h_" + line[0:colonPos] + "_EXCEPT_FINE\", \"\", 10000, min, max);\n")
		...
		Histo_Custom_Book_Functions.write("\thv_" + line[0:colonPos] + ".push_back(h_" + line[0:colonPos] + "_EXCEPT_FINE);\n")	
		...
		Histo_Custom_Book_Functions.write("\thv_" + line[0:colonPos] + "_names.push_back(\"h_" + line[0:colonPos] + "_EXCEPT_FINE\");\n")
