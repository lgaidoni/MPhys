...
def AnalysisAutoGen(InputTLorentzName, DesiredTLorentzName, Units):
	if InputTLorentzName == DesiredTLorentzName:
		...
		_DrawHistos.write("\tDrawHistogram(h_" + leafName + "_" + TLorentzName + ", \"" + leafName + "_" + TLorentzName + "\", \"" + leafName + "_" + TLorentzName + "_\" + AnalysisType, \"" + Units + "\", 600, 400, false, \"h_" + leafName + "_" + TLorentzName + "_\" + AnalysisType + \".pdf\", AnalysisType);\n")
		_DrawHistos.write("\tDrawHistogram(h_" + leafName + "_" + TLorentzName + "_PRE, \"" + leafName + "_" + TLorentzName + "_PRE\", \"" + leafName + "_" + TLorentzName + "_PRE_\" + AnalysisType, \"" + Units + "\", 600, 400, false, \"h_" + leafName + "_" + TLorentzName + "_PRE_\" + AnalysisType + \".pdf\", AnalysisType);\n\n")
