...
// Tue Nov 20 10:01:32 2018 by ROOT version 6.14/04
// from TTree NOMINAL/NOMINAL
// found on file: /pc2014-data4/sam/VBF_Ztt/HIGG8D1/v5.0/data/user.sdysch.v5.0.data15_13TeV.00276262.physics_Main.D1.r9264_p3083_p3372.sv1.1_hist/user.sdysch.14363273._000001.hist-output.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           fCurrent; //!current Tree number in a TChain
	...
	#include "Histo_Book_Definitions_AutoGen_DATA.h"

	/////-------------------------CUSTOM HISTOGRAM DEFINITIONS------------------------/////
	#include "Histo_Book_Definitions_AutoGen_Custom_DATA.h"
...
#ifdef DATA_Analysis_cxx
DATA_Analysis::DATA_Analysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pc2014-data4/sam/VBF_Ztt/HIGG8D1/v5.0/data/user.sdysch.v5.0.data15_13TeV.00276262.physics_Main.D1.r9264_p3083_p3372.sv1.1_hist/user.sdysch.14363273._000001.hist-output.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pc2014-data4/sam/VBF_Ztt/HIGG8D1/v5.0/data/user.sdysch.v5.0.data15_13TeV.00276262.physics_Main.D1.r9264_p3083_p3372.sv1.1_hist/user.sdysch.14363273._000001.hist-output.root");
      }
...
Int_t DATA_Analysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DATA_Analysis::LoadTree(Long64_t entry)
{
...
void DATA_Analysis::Init(TTree *tree)
{
...
void DATA_Analysis::Show(Long64_t entry)
{
...
Int_t DATA_Analysis::Cut(Long64_t entry)
{
