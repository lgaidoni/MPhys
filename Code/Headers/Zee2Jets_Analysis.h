...
void MC_Analysis::Zee2Jets_DrawHistos() {
	...
	// Dilepton Rapidity
	DrawHistogram(h_RapidityDilepton_PRE, "h_RapidityDilepton_PRE", "h_RapidityDilepton_PRE_" + AnalysisType , "Dilepton rapidity of elec_0 and elec_1  with initial selection cuts from " + AnalysisType + " data set;Dilepton Rapidity [rads];Entries", 600, 400, false, "h_RapidityDilepton_PRE_" + AnalysisType + ".pdf", AnalysisType);
	DrawHistogram(h_RapidityDilepton, "h_RapidityDilepton", "h_RapidityDilepton_" + AnalysisType , "Dilepton rapidity of elec_0 and elec_1  with further cuts from " + AnalysisType + " data set;Dilepton Rapidity [rads];Entries", 600, 400, false, "h_RapidityDilepton_" + AnalysisType + ".pdf", AnalysisType);
	DrawHistogram(h_RapidityDilepton_CONTROL, "h_RapidityDilepton_CONTROL", "h_RapidityDilepton_CONTROL_" + AnalysisType , "Dilepton rapidity of elec_0 and elec_1  with control cuts from " + AnalysisType + " data set;Dilepton Rapidity [rads];Entries", 600, 400, false, "h_RapidityDilepton_CONTROL_" + AnalysisType + ".pdf", AnalysisType);

	// Dijet Rapidity
	DrawHistogram(h_RapidityDijet_PRE, "h_RapidityDijet_PRE", "h_elec_0_elec_1_RapidityDijet_PRE_" + AnalysisType , "Dijet rapidity of ljet_0 and ljet_1  with initial selection cuts from " + AnalysisType + " data set;Dijet Rapidity [rads];Entries", 600, 400, false, "h_RapidityDijet_PRE_" + AnalysisType + ".pdf", AnalysisType);
	DrawHistogram(h_RapidityDijet, "h_RapidityDijet", "h_elec_0_elec_1_RapidityDijet_" + AnalysisType , "Dijet rapidity of ljet_0 and ljet_1  with further cuts from " + AnalysisType + " data set;Dijet Rapidity [rads];Entries", 600, 400, false, "h_RapidityDijet_" + AnalysisType + ".pdf", AnalysisType);
	DrawHistogram(h_RapidityDijet_CONTROL, "h_RapidityDijet_CONTROL", "h_elec_0_elec_1_RapidityDijet_CONTROL_" + AnalysisType , "Dijet rapidity of ljet_0 and ljet_1  with control cuts from " + AnalysisType + " data set;Dijet Rapidity [rads];Entries", 600, 400, false, "h_RapidityDijet_CONTROL_" + AnalysisType + ".pdf", AnalysisType);
