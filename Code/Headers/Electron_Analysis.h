#ifndef Electron_Analysis_h
#define Electron_Analysis_h
...
void MC_Analysis::Electron_BookHistos() {
...
bool MC_Analysis::Electron_InitialCut() {
...
void MC_Analysis::Electron_GenerateVariables() {
...
void MC_Analysis::Electron_FillAllData_PreCut() {
	...
	//ptvarcones
	h_elec_0_iso_ptvarcone20_PRE->Fill(elec_0_iso_ptvarcone20, Luminosity_Weight * weight_total);
	h_elec_0_iso_ptvarcone40_PRE->Fill(elec_0_iso_ptvarcone40, Luminosity_Weight * weight_total);

	//Invariant mass
	h_elec_0_elec_1_mass_PRE->Fill(elec_0_elec_1_mass, Luminosity_Weight * weight_total);
	...
	h_elec_0_elec_1_pt_PRE->Fill(elec_0_elec_1_pt, Luminosity_Weight * weight_total);
...
void MC_Analysis::Electron_CutAndFill() {
	   ...
	   pT_balance_limit)			// pT balance limit
	{
		...
		h_elec_0_elec_1_mass_EXCEPT->Fill(elec_0_elec_1_mass, Luminosity_Weight * weight_total);//Fill the EXCEPT histogram for mass
	   ...
	   pT_balance_limit)			// pT balance limit
	{
		...
		h_elec_0_elec_1_pt_EXCEPT->Fill(elec_0_elec_1_pt, Luminosity_Weight * weight_total);//Fill the EXCEPT histogram for combined lepton pt
	   ...
	   pT_balance_limit)			// pT balance limit
	{
		...
		h_elec_0_iso_ptvarcone20_EXCEPT->Fill(elec_0_iso_ptvarcone20, Luminosity_Weight * weight_total);
	   ...
	   pT_balance_limit)			// pT balance limit
	{
		...
		h_elec_0_iso_ptvarcone40_EXCEPT->Fill(elec_0_iso_ptvarcone40, Luminosity_Weight * weight_total);
	...
	if (common_cuts && rap_int_condition && pT_balance_limit) {
		...
		//ptvar cone histograms
		h_elec_0_iso_ptvarcone20->Fill(elec_0_iso_ptvarcone20, Luminosity_Weight * weight_total);
		h_elec_0_iso_ptvarcone40->Fill(elec_0_iso_ptvarcone40, Luminosity_Weight * weight_total);

		//topoet cone histograms
		h_elec_0_iso_topoetcone20->Fill(elec_0_iso_topoetcone20, Luminosity_Weight * weight_total);
		h_elec_0_iso_topoetcone40->Fill(elec_0_iso_topoetcone40, Luminosity_Weight * weight_total);

		//Invariant mass
		h_elec_0_elec_1_mass->Fill(elec_0_elec_1_mass, Luminosity_Weight * weight_total); // two electrons
		...
		h_elec_0_elec_1_pt->Fill(elec_0_elec_1_pt, Luminosity_Weight * weight_total);
		...
		//ptvar cone histograms
		h_elec_0_iso_ptvarcone20_CONTROL->Fill(elec_0_iso_ptvarcone20, Luminosity_Weight * weight_total);
		h_elec_0_iso_ptvarcone40_CONTROL->Fill(elec_0_iso_ptvarcone40, Luminosity_Weight * weight_total);

		//Invariant mass
		h_elec_0_elec_1_mass_CONTROL->Fill(elec_0_elec_1_mass, Luminosity_Weight * weight_total); // two electrons
		...
		h_elec_0_elec_1_pt_CONTROL->Fill(elec_0_elec_1_pt, Luminosity_Weight * weight_total);
...
void MC_Analysis::Electron_DrawHistos() {
