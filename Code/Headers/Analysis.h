...
void MC_Analysis::BookHistos() {
	...
	// BDT stuff TEST
	int tau_0_ele_BDT_SCORE_TRANS_Min = 0, tau_0_ele_BDT_SCORE_TRANS_Max = 1;
	int tau_0_ele_BDT_SCORE_Min = 0, tau_0_ele_BDT_SCORE_Max = 1;
	int tau_0_jet_BDT_SCORE_Min = 0, tau_0_jet_BDT_SCORE_Max = 1;
	int tau_0_jet_BDT_SCORE_TRANS_Min = 0, tau_0_jet_BDT_SCORE_TRANS_Max = 1;
	...
	int MET_Type_Favour_OUTSIDE_Min = -1, MET_Type_Favour_OUTSIDE_Max = 2;
  	...
  	int lep_0_lep_1_mass_reco_EXTENDED_Min = 0, lep_0_lep_1_mass_reco_EXTENDED_Max = 1000;
...
bool MC_Analysis::InitialCut(bool bjets, bool truth) { // true = cut, false = keep
	...
	bool lep_0_trig = false;
	bool lep_1_trig = false;
	bool single_lepton_trigger = false;
	...
	if (weight_total_override) current_run_number = run_number;
...
//		cout << "RECIPE for Higgs" << endl << endl;
		...
		if (AnalysisType == "Electron") { // lep_0 = elec_0, lep_1 = elec_1
			...
			if (current_run_number <= 284484 && current_run_number >= 276262 ) {// 2015
				if (eleTrigMatch_0_trigger_matched && ( (HLT_e24_lhmedium_L1EM20VH && lep_0_pt > 25.) || (HLT_e60_lhmedium && lep_0_pt > 61.) || (HLT_e120_lhloose && lep_0_pt > 121.) ) ) { lep_0_trig = true; single_lepton_trigger = true; }
				else if (eleTrigMatch_1_trigger_matched && ( (HLT_e24_lhmedium_L1EM20VH && lep_1_pt > 25.) || (HLT_e60_lhmedium && lep_1_pt > 61.) || (HLT_e120_lhloose && lep_1_pt > 121.) ) ) { lep_1_trig = true; single_lepton_trigger = true; }
			}
			else if (current_run_number <= 311481  && current_run_number >= 297730 ) { //2016
				if (eleTrigMatch_0_trigger_matched && ( (HLT_e26_lhtight_nod0_ivarloose && lep_0_pt > 27.) || (HLT_e60_lhmedium_nod0 && lep_0_pt > 61.) || (HLT_e140_lhloose_nod0 && lep_0_pt > 141.) ) ) { lep_0_trig = true; single_lepton_trigger = true; }
				else if (eleTrigMatch_1_trigger_matched && ( (HLT_e26_lhtight_nod0_ivarloose && lep_1_pt > 27.) || (HLT_e60_lhmedium_nod0 && lep_1_pt > 61.) || (HLT_e140_lhloose_nod0 && lep_1_pt > 141.) ) ) { lep_1_trig = true; single_lepton_trigger = true; }
			}
			...
			if (elec_0_id_medium == 1) { // selecting medium electrons
				...
				//recipe_weighting *= elec_0_NOMINAL_EleEffSF_Isolation_MediumLLH_d0z0_v13_isolGradient; // electron isolation weights: commented out as always ZERO
		...
		if (AnalysisType == "ElectronTau") { // lep_1 = elec_0, lep_0 = tau_0
			// anything with lep_1 is OK as for electron but double check lep_0 stuff as may not be reasonable to make on tau
			...
			// Kinematic Cuts
			// maybe remove this lep_0 for TAU!
			if (lep_0_eta < 2.47 && lep_1_eta < 2.47) abs_eta_recipe_condition = true; // electron eta
		...
		if (AnalysisType == "Muon") { // for all cases with muon_0 = lep_0, lep_1 = muon_1
			...
			// Single lepton trigger
			if (current_run_number <= 284484 && current_run_number >= 276262 ) {//2015
				if (muTrigMatch_0_trigger_matched && ( (HLT_mu20_iloose_L1MU15 && lep_0_pt > 21.) || (HLT_mu50 && lep_0_pt > 51.) ) ) { lep_0_trig = true; single_lepton_trigger = true; }
				else if (muTrigMatch_1_trigger_matched && ( (HLT_mu20_iloose_L1MU15 && lep_1_pt > 21.) || (HLT_mu50 && lep_1_pt > 51.) ) ) { lep_1_trig = true; single_lepton_trigger = true; }
			}
			else if (current_run_number <= 311481  && current_run_number >= 297730 ) {//2016
				if (muTrigMatch_0_trigger_matched && ( (HLT_mu26_ivarmedium && lep_0_pt >27. ) || (HLT_mu50 && lep_0_pt > 51.) ) ) { lep_0_trig = true; single_lepton_trigger = true; }
				else if (muTrigMatch_1_trigger_matched && ( (HLT_mu26_ivarmedium && lep_1_pt >27. ) || (HLT_mu50 && lep_1_pt > 51.) ) ) { lep_1_trig = true; single_lepton_trigger = true; }
			}
			else if (current_run_number <= 341649 && current_run_number >= 323427 ) {//2017
				if (muTrigMatch_0_trigger_matched && ( (HLT_mu26_ivarmedium && lep_0_pt > 27.) || (HLT_mu50 && lep_0_pt > 51.) ) ) { lep_0_trig = true; single_lepton_trigger = true; }
				else if (muTrigMatch_1_trigger_matched && ( (HLT_mu26_ivarmedium && lep_1_pt > 27.) || (HLT_mu50 && lep_1_pt > 51.) ) ) { lep_1_trig = true; single_lepton_trigger = true; }
		...
		if (AnalysisType == "MuonTau") { // for all cases with muon_0 = lep_0, lep_1 = tau_0
			...
			if (lep_1_eta < 2.7 && lep_0_eta < 2.7) abs_eta_recipe_condition = true; // muon / or tau eta
			// Lepton reconstruction and isolation cuts = weights
			if (muon_0_iso_Gradient == 1)  isolation_cut = true;
	...
	if (higgs_analysis) { // make sure all recipe is accepted
		if (isolation_cut && abs_eta_recipe_condition && lepton_certainty_check_1 && lepton_certainty_check_2 && no_primary_vertices && single_lepton_trigger) recipe_cuts = true;
	}
...
void MC_Analysis::GenerateVariables(bool truth) {
	...
	// BDT STUFF
	tau_0_ele_BDT_SCORE_TRANS = tau_0_ele_BDTEleScoreTrans_run2;
	tau_0_ele_BDT_SCORE = tau_0_ele_bdt_score;
	tau_0_jet_BDT_SCORE = tau_0_jet_bdt_score;
	tau_0_jet_BDT_SCORE_TRANS = tau_0_jet_bdt_score_trans;
...
void MC_Analysis::FillAllData_PreCut() {
	...
	if (AnalysisType == "MuonTau" or AnalysisType == "ElectronMuon" or AnalysisType == "ElectronTau") {
		...
		h_lep_0_lep_1_mass_reco_EXTENDED_PRE->Fill(lep_0_lep_1_mass_reco, final_weighting);
	...
	if (region == "normal") {
		...
		if (AnalysisType == "MuonTau" or AnalysisType == "ElectronMuon" or AnalysisType == "ElectronTau") {
			...
			if (EXCEPT_Z_mass_condition) {
				...
				h_lep_0_lep_1_mass_reco_EXTENDED_EXCEPT->Fill(lep_0_lep_1_mass_reco, final_weighting);	//Fill the EXCEPT histogram for reconstructed mass
				h_lep_0_lep_1_mass_reco_EXTENDED_EXCEPT_FINE->Fill(lep_0_lep_1_mass_reco, final_weighting);
			}
		...
		if (Cuts("search")) {
			...
			if (AnalysisType == "MuonTau" or AnalysisType == "ElectronMuon" or AnalysisType == "ElectronTau") {
				...
				h_lep_0_lep_1_mass_reco_EXTENDED->Fill(lep_0_lep_1_mass_reco, final_weighting);
				...
				// BDT STUFF
				h_tau_0_ele_BDT_SCORE_TRANS->Fill(tau_0_ele_BDT_SCORE_TRANS, final_weighting);
				h_tau_0_ele_BDT_SCORE->Fill(tau_0_ele_BDT_SCORE, final_weighting);
				h_tau_0_jet_BDT_SCORE->Fill(tau_0_jet_BDT_SCORE, final_weighting);
				h_tau_0_jet_BDT_SCORE_TRANS->Fill(tau_0_jet_BDT_SCORE_TRANS, final_weighting);
		...
		if (Cuts("control")) {
			...
			if (AnalysisType == "MuonTau" or AnalysisType == "ElectronMuon" or AnalysisType == "ElectronTau") {
				...
				h_lep_0_lep_1_mass_reco_EXTENDED_CONTROL->Fill(lep_0_lep_1_mass_reco, final_weighting);
		...
		if (Cuts("high_energy")) {
			...
			if (AnalysisType == "MuonTau" or AnalysisType == "ElectronMuon" or AnalysisType == "ElectronTau") {
				...
				h_lep_0_lep_1_mass_reco_EXTENDED_HIGH_E->Fill(lep_0_lep_1_mass_reco, final_weighting);
...
void MC_Analysis::DrawHistos(string higgs_suffix) {
	...
	DrawHistogram_PRE_SEARCH_CONTROL_EXCEPT(h_lep_0_lep_1_mass_reco_EXTENDED_PRE, h_lep_0_lep_1_mass_reco_EXTENDED, h_lep_0_lep_1_mass_reco_EXTENDED_CONTROL, h_lep_0_lep_1_mass_reco_EXTENDED_EXCEPT, "lep_0_lep_1_mass_reco_EXTENDED", "Pre-Cut", "Post Cut", "Control", "Except", "h_lep_0_lep_1_mass_reco_EXTENDED", ";Z mass incl neutrinos;Events", true, draw_histograms, ChainName, AnalysisType, higgs_suffix);	
	...
	DrawHistogram(h_lep_0_lep_1_mass_reco_EXTENDED_HIGH_E, "h_lep_0_lep_1_mass_reco_HIGH_E", ";;Events", false, true, ChainName, AnalysisType, higgs_suffix);
	...
	DrawHistogram(h_lep_0_lep_1_mass_reco_EXTENDED_EXCEPT_FINE, "h_lep_0_lep_1_mass_reco_EXCEPT_FINE", ";;Events", false, true, ChainName, AnalysisType, higgs_suffix);
	...
	DrawHistogram(h_lep_0_vis_mass_TRUTH, "h_lep_0_vis_mass_TRUTH", ";;Events", false, true, ChainName, AnalysisType, higgs_suffix);
	DrawHistogram(h_lep_1_vis_mass_TRUTH, "h_lep_1_vis_mass_TRUTH", ";;Events", false, true, ChainName, AnalysisType, higgs_suffix);
	...
	DrawHistogram(h_met_truth_energy_TRUTH, "h_met_truth_energy_TRUTH", ";;Events", false, true, ChainName, AnalysisType, higgs_suffix);
	DrawHistogram(h_lep_0_invis_energy_TRUTH, "h_lep_0_invis_energy_TRUTH", ";;Events", false, true, ChainName, AnalysisType, higgs_suffix);
