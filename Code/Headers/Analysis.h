...
void MC_Analysis::FillAllData_PreCut() {
	...
	// unit vector of total transverse momentum PRE
	h_TOT_pT_UnitVector_PRE->Fill(TOT_pT_UnitVector, final_weighting);

	// unit vector of total missing transverse momentum PRE
	h_MET_UnitVector_PRE->Fill(MET_UnitVector, final_weighting);
...
void MC_Analysis::DrawHistos() {
	...
	DrawHistogram_Quiet(h_TOT_pT_UnitVector_BJET, "h_TOT_pT_UnitVector_BJET", "h_TOT_pT_UnitVector_BJET", ";;Events", 600, 400, false, "h_TOT_pT_UnitVector_BJET" + ChainName + ".pdf", ChainName, AnalysisType);
	DrawHistogram_Quiet(h_TOT_pT_UnitVector_BJET, "h_MET_UnitVector_BJET", "h_MET_UnitVector_BJET", ";;Events", 600, 400, false, "h_MET_UnitVector_BJET" + ChainName + ".pdf", ChainName, AnalysisType);
