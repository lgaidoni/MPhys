...
void MC_Analysis::Zee2Jets_BookHistos() {
	...
	///------------------------------------ elec_0 --------------------------------------///
	//et cone histograms
	Book_elec_0_iso_etcone20(bins, -12, 1);
	Book_elec_0_iso_etcone30(bins, -12, 1);
	Book_elec_0_iso_etcone40(bins, -12, 1);

	//pt cone histograms
	Book_elec_0_iso_ptcone20(bins, -12, 1);
	Book_elec_0_iso_ptcone30(bins, -12, 1);
	Book_elec_0_iso_ptcone40(bins, -12, 1);

	//ptvar cone histograms
	Book_elec_0_iso_ptvarcone20(bins, -12, 100000);
	Book_elec_0_iso_ptvarcone30(bins, -12, 100000);
	Book_elec_0_iso_ptvarcone40(bins, -12, 100000);

	//topoet cone histograms
	Book_elec_0_iso_topoetcone20(bins, -12, 800000);
	Book_elec_0_iso_topoetcone30(bins, -12, 800000);
