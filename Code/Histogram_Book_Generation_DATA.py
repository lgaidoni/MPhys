...
Histo_Book_Functions_AutoGen = open("Headers/Histo_Book_Functions_AutoGen_DATA.h", "w")

#Histogram Definitions
Histo_Definitions = open("Headers/Histo_Book_Definitions_AutoGen_DATA.h", "w")

#DATA_Analysis to be read
DATA_Analysis = open("Headers/DATA_Analysis.h", "r")

#To fill the _BookHistos Function inside SOMETHING_Analysis.h
_BookHistos = open("Headers/_BookHistos_DATA.h", "w")

#To fill the _FillAllData_PreCut Function inside SOMETHING_Analysis.h
_FillAllData_PreCut = open("Headers/_FillAllData_PreCut_DATA.h", "w")

#To fill the _FillAllData_PostCut Function inside SOMETHING_Analysis.h
_FillAllData_PostCut = open("Headers/_FillAllData_PostCut_DATA.h", "w")

#To fill the _FillAllData_ControlCut Function inside SOMETHING_Analysis.h
_FillAllData_ControlCut = open("Headers/_FillAllData_ControlCut_DATA.h", "w")

#To fill the _DrawHistos Function inside SOMETHING_Analysis.h
_DrawHistos = open("Headers/_DrawHistos_DATA.h", "w")
...
Histo_Custom_Book_Functions = open("Headers/Histo_Book_Functions_AutoGen_Custom_DATA.h", "w")

#Histogram Booking Definitions for Custom Histograms
Histo_Custom_Book_Definitions = open("Headers/Histo_Book_Definitions_AutoGen_Custom_DATA.h", "w")
	...
	if reader == 1:
		...
		if line[3:17] == "TLorentzVector":
			...
			for lorentzline in TLorentzVector_Leaves:
				...
				Histo_Definitions.write("\t\tvirtual void Book_" + leafName + "_" + TLorentzName + "_EXCEPT(int bins, double min, double max);\n")
				...
				Histo_Book_Functions_AutoGen.write("\tvoid DATA_Analysis::Book_" + leafName + "_" + TLorentzName + "(int bins, double min, double max) {\n")
				...
				Histo_Book_Functions_AutoGen.write("\tvoid DATA_Analysis::Book_" + leafName + "_" + TLorentzName + "_CONTROL(int bins, double min, double max) {\n")
				...
				Histo_Book_Functions_AutoGen.write("\t}\n")
				Histo_Book_Functions_AutoGen.write("\tvoid DATA_Analysis::Book_" + leafName + "_" + TLorentzName + "_EXCEPT(int bins, double min, double max) {\n")
				...
				Histo_Book_Functions_AutoGen.write("\t}\n")
				Histo_Book_Functions_AutoGen.write("\tvoid DATA_Analysis::Book_" + leafName + "_" + TLorentzName + "_PRE(int bins, double min, double max) {\n")
		...
		#If the leaf is anything else
			...
			Histo_Definitions.write("\tvirtual void Book_" + leafName + "_EXCEPT(int bins, double min, double max);\n")
			...
			#Write out the booking functions to be included at the end of DATA_Analysis.C
			Histo_Book_Functions_AutoGen.write("//Histogram booking function for " + leafName + "\n")
			Histo_Book_Functions_AutoGen.write("void DATA_Analysis::Book_" + leafName + "(int bins, double min, double max) {\n")
			Histo_Book_Functions_AutoGen.write("\th_" + leafName + " = new TH1F(\"h_" + leafName + "\", \"\", bins, min, max);\n")
			Histo_Book_Functions_AutoGen.write("}\n")
			Histo_Book_Functions_AutoGen.write("void DATA_Analysis::Book_" + leafName + "_CONTROL(int bins, double min, double max) {\n")
			Histo_Book_Functions_AutoGen.write("\th_" + leafName + "_CONTROL = new TH1F(\"h_" + leafName + "_CONTROL\", \"\", bins, min, max);\n")
			Histo_Book_Functions_AutoGen.write("}\n\n")
			Histo_Book_Functions_AutoGen.write("void DATA_Analysis::Book_" + leafName + "_EXCEPT(int bins, double min, double max) {\n")
			Histo_Book_Functions_AutoGen.write("\th_" + leafName + "_EXCEPT = new TH1F(\"h_" + leafName + "_EXCEPT\", \"\", bins, min, max);\n")
			Histo_Book_Functions_AutoGen.write("}\n\n")
			Histo_Book_Functions_AutoGen.write("void DATA_Analysis::Book_" + leafName + "_PRE(int bins, double min, double max) {\n")
...
for line in Custom_Histos:
	...
	if line[0:2] == "##": # If the line is a comment for separating things out
		...
		Histo_Custom_Book_Definitions.write("virtual void Book_" + line[0:colonPos] + "_EXCEPT(int bins, double min, double max); // EXCEPT VERSION\n")
		...
		Histo_Custom_Book_Functions.write("void DATA_Analysis::Book_" + line[0:colonPos] + "_PRE(int bins, double min, double max) {\n")
		...
		Histo_Custom_Book_Functions.write("void DATA_Analysis::Book_" + line[0:colonPos] + "_CONTROL(int bins, double min, double max) {\n")
		Histo_Custom_Book_Functions.write("\th_" + line[0:colonPos] + "_CONTROL = new TH1F(\"h_" + line[0:colonPos] + "_CONTROL\", \"\", bins, min, max);\n")
		Histo_Custom_Book_Functions.write("}\n")

		Histo_Custom_Book_Functions.write("void DATA_Analysis::Book_" + line[0:colonPos] + "_EXCEPT(int bins, double min, double max) {\n")
		Histo_Custom_Book_Functions.write("\th_" + line[0:colonPos] + "_EXCEPT = new TH1F(\"h_" + line[0:colonPos] + "_EXCEPT\", \"\", bins, min, max);\n")
		Histo_Custom_Book_Functions.write("}\n")

		Histo_Custom_Book_Functions.write("void DATA_Analysis::Book_" + line[0:colonPos] + "(int bins, double min, double max) {\n")
